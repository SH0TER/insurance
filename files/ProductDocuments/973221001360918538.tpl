...
<html>
<head>
	<title>ЗАЯВА на  страхування  від  нещасних  випадків, Астра Банк</title>
...
<table width="100%" cellspacing="0" cellpadding="5">
	<tr>
		<td width="30%"><b>1. Страхувальник/Застрахована особа (ПІБ):</b></td>
...
<table width="100%" cellspacing="0" cellpadding="5">
	<tr>
		<td width="30%"><b>2. Дата народження:</b></td>
...
<table width="100%" cellspacing="0" cellpadding="5">
	<tr>
		<td width="30%"><b>3. Домашня адреса:</b></td>
...
<table width="100%" cellspacing="0" cellpadding="5">
	<tr>
		<td width="30%"><b>4. Місце роботи:</b></td>
		<td class="all">{$values.insurer_company}</td>
	</tr>
</table><br />

<table width="100%" cellspacing="0" cellpadding="5">
	<tr>
		<td width="30%"><b>5. Посада:</b></td>
		<td class="all">{$values.insurer_position}</td>
	</tr>
</table><br />

<table width="100%" cellspacing="0" cellpadding="5">
	<tr>
		<td width="30%"><b>6. Заняття активними видами спорту:</b></td>
		<td class="all">{$values.insurer_sport}</td>
	</tr>
</table><br />	

<p><b>7. Страхувальник/Застрахована особа бажає отримати страховий захист за наступними страховими випадками:</b></p>
<table cellspacing="0" cellpadding="5" width="100%">
	<tr>
		<td class="left top bottom right" width="70%">Смерть, яка настала внаслідок нещасного випадку</td>
		<!--td class="all" width="10%">{if $values.ns_death}Так{else}Ні{/if}</td-->
	</tr>
	<tr>
		<td class="left bottom right" width="70%">Встановлення І групи інвалідності, яка настала внаслідок нещасного випадку</td>
...
<table cellspacing="0" cellpadding="5" width="100%">
	<tr>
		<td width="30%"><b>8. Страхова сума:</b></td>
		<td class="all">{$values.price|moneyformat:-1}</td>
	</tr>
</table><br />

<table cellspacing="0" cellpadding="5" width="100%">
	<tr>
		<td width="30%"><b>9. Період  страхування:</b></td>
...
<table cellspacing="0" cellpadding="5" width="100%">
	<tr>
		<td width="30%"><b>10. Територія, час дії Договору страхування в межах проміжку доби:</b></td>
		<!--td class="all">{$values.correct_factors.3}</td-->
		<td class="all">Україна, цілодобово</td>
	</tr>
</table><br />
...
<table>
	<tr>
		<td>
			Страхування  здійснюється   на  стандартних  умовах, на  підставі   Правил ТДВ "Експрес Страхування" добровільного страхування від нещасних випадків, зареєстрованих Державною комісією з регулювання ринків фінансових послуг України  23 жовтня 2008 р.
		</td>
	</tr>
</table>
</body>
