...
{elseif $values.agreement_types_id==3}
<div align=right>
Додаток 1<br> 
...
<tr>
	...
	<td align="center">
        ...
        <h1>Договір добровільного страхування наземних транспортних засобів <br> ПРОГРАМА "КОМФОРТ"</h1>
...
{elseif $values.agencies_id == 1496 || $values.agencies_id == 1497 || $values.agencies_id == 1498 || $values.agencies_id == 1469 && $values.seller_agencies_id == 0 || $values.ukravto == 0}
...
<tr>
	...
	<td>
		Страховий платіж за строк дії першого періоду страхування за Договором сплачується одноразово у розмірі 100% такого платежу в день укладання Договору. Якщо страховий платіж за строк дії першого періоду страхування не надійшов, то даний Договір вважається таким, що не набув чинності. Страхові платежі за строки дії наступих періодів страхування сплачуються Страхувальником відповідно до графіку, вказаному в п.12 частини А Договору. У випадку несплати Страхувальником страхового платежу за наступні строки дії періодів страхування або сплати не в повному обсязі, діють умови п.7.4., 7.5. частини Б Договору. <br><br>
	</td>
</tr>
<tr>
	<td width="20%"><b>13.1. Порядок сплати страхового платежу при використанні опціїї "50/50"</b></td>
	<td>
		У випадку застосування опції "50/50", додатковий страховий платіж за Договором сплачується на умовах та в розмірі, зазначених в п.16.1. частини Б Договору.<br><br>
	</td>
</tr>
<tr>
	<td width="20%"><b>13.2. Порядок сплати страхового платежу при використанні опції "перший місяць страхування за 500 грн."</b></td>
	<td>
		Перша частина страхового платежу у розмірі 500 грн. за строк дії першого періоду страхування за Договором, який складає 30 календарних днів, сплачується в строк, зазначений у п.12 частини А Договору. <br><br>
		
		Страховий платіж за строк дії другого періоду страхування за Договором сплачується Страхувальником відповідно до графіку, вказаному в п.12 частини А Договору, згідно з умовами п. 16.2. частини Б Договору.  <br><br>
	</td>
</tr>
</table><br />
...
{if $values.seller_agencies_id != 0 || $values.agencies_id != 1469 && $values.agencies_id != 1496 && $values.agencies_id != 1497 && $values.agencies_id != 1498 && $values.sign_agents_id!=13944}
<tr>
