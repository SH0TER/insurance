...
<html>
<head>
	<title>КАСКО. Заявление Премиум</title>
		...
		<td>
			...
			<table cellspacing=0 cellpadding=5 width="100%">
				...
				<tr>
					...
					<td class="right bottom left">&nbsp;{$values.modification}</td>
					<td align="right">об'єм двигуна</td>
					<td class="right bottom left">{$values.engine_size}</td>
					<td class="right bottom" align="right">рік випуску</td>
					<td class="right bottom">{$values.year}</td>
...
<table cellspacing=0 cellpadding=5 width="100%">
	<tr>
		...
		<td>
			...
			<table cellspacing=0 cellpadding=5 width="100%">
				<tr>
					<td class="top right bottom left">за ризиками 5.1. - 5.6.: {$values.deductibles_value0|sign:$values.deductibles_absolute0}; за ризиком 5.7.: {$values.deductibles_value1|sign:$values.deductibles_absolute1}</td>
				</tr>
			</table><br />
			<p>Місце дії Договору страхування:</p>
			<table cellspacing=0 cellpadding=5 width="100%">
				<tr>
					<td class="top right bottom left">Україна + Європа + європейська частина країн СНД (крім зон воєнних дій, конфліктів та прирівняних до них)</td>
				</tr>
			</table>
...
<table cellspacing=0 cellpadding=5 width="100%">
	<tr>
		<td rowspan="9" width="20%" valign="top"><b>10. Додаткові опції</b></td>
