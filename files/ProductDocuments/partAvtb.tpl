...
{elseif $values.ground_kasko && $values.agencies_edrpou != $values.insurer_edrpou && $values.agencies_id!=560 && $values.agencies_id!=1486 && $values.agencies_id!=1469111}
	<p>
	Цей договір добровільного страхування наземних транспортних засобів /далі - Договір/ укладений {$values.agencies_title} (надалі - Страховик), Ліцензії серії АВ №429899 від 04.11.2008 р., в особі {$values.director2} та {$values.findirector2}, що діють на підставі {$values.ground_kasko} від імені та в інтересах ТДВ "Експрес Cтрахування". Договір укладений  відповідно до Закону України "Про страхування",  та Правил ТДВ "ЕКСПРЕС СТРАХУВАННЯ" добровільного страхування наземного транспорту (крім залізничного) від 13 жовтня 2008 р.
	</p>
{else}
...
<tr>
	...
	<td class="left right top" colspan="7">
		ПАТ «ВТБ БАНК» (код ЄДРПОУ 321767, юридична адреса: 01004, Україна, м. Київ, бул  Шевченка/вул. Пушкінська 8/26,
		поштова адреса: 01601, Україна, м. Київ, вул. Воровського 24
	</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<tr>
	...
	<td class="top right bottom center {if $values.hijacking == 0}u{/if}">7.Незаконне<br />заволодіння (а також при повній конструктивній загибелі ТЗ )</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td>{$values.yearsPayments[roll].date|date_format:$smarty.const.DATE_FORMAT_SMARTY}р.</td>
...
<table cellpadding="5" cellspacing="0" width="100%">
    <tr>
        <td width="20%" rowspan="7" valign="top"><b>14. Додаткові опції</b></td>
...
<p>1.  Даних особливих умов страхування, підписаних Страховиком та Страхувальником (частина А Договору). Особливі умови страхування підписуються у 3 (трьох) примірниках, що мають однакову юридичну силу, по одному для Страховика, Страхувальника та Вигодонабувача.
<p>2. Трьох примірників загальних умов страхування (частина Б Договору), що мають однакову юридичну силу, по одному для Страховика та Страхувальника, Вигодонабувача.
<p>3.  Заяви на страхування, що підписана Страхувальником та на підставі якої був укладений Договір. Заява підписується у 3 (трьох) примірниках, що мають однакову юридичну силу, по одному для Страховика, Страхувальника та Вигодонабувача.
<p>4. Акту огдялу ТЗ, підписаних Страховиком (або його представником) та Страхувальником. Акт огляду ТЗ підписується у 3 (трьох) примірниках, що мають однакову юридичну силу, по одному для Страховика, Страхувальника та Вигодонабувача.
<p>5. Договір страхування є дійсним при наявності всіх частин, що підписані Сторонами та Вигодонабувачем. Страхувальник має право отримати дублікат Договору або його частин у випадку втрати. 
