...
<table cellspacing=0 cellpadding=0 width="100%">
    <tr>
        ...
        <td align="center">
            ...
            <p><h1>Частина "А" Договору страхування - Особливі умови страхування</h1>
...
<table cellpadding="5" cellspacing="0" width="100%">
    ...
    <tr>
        <td><b>8. Безумовна франшиза<div class="small">(у % від страхової суми)</b></div></td>
        <td class="left bottom right center">
            <table>
                <tr>
                    <td>при пошкодженнях ТЗ</td>
                    <td>{if $values.dtp != 0}{$values.deductibles_value0|sign:$values.deductibles_absolute0}{else}------{/if}</td>
                </tr>
                <tr>
                    <td>при повній загибелі ТЗ</td>
                    <td>1,0</td>
                </tr>
            </table></td>
...
<table cellpadding="5" cellspacing="0" width="100%">
    <tr>
        <td width="20%"><b>11. Строк дії періодів страхування за Договором . Страхова сума. Страховий тариф. Страховий платіж та строк його сплати</b></td>
        <td> 
...
<table cellpadding="5" cellspacing="0" width="100%">
    <tr>
        <td width="20%" rowspan="{if $values.products_id==597}8{else}7{/if}" valign="top"><b>14. Додаткові опції</b></td>
    ...
    <tr>
        <td class="right bottom left">{if $values.financial_institutions_id==25 || $values.financial_institutions_id==59}опція "Розумне КАСКО" {else}опція страхування "50/50"{/if}</td>
        <td class="right bottom">так</td>
    </tr>
    {/if}
</table><br />
...
<table cellpadding="2" cellspacing="4" width="100%">
    <tr>
        <td {if $values.agencies_id==560111 ||$values.agencies_id==1486111 || $values.agencies_id==1469111} width="33%" {else} width="48%" {/if} align="center"><b>СТРАХОВИК</b></td>
        <td {if $values.agencies_id==560111 ||$values.agencies_id==1486111 || $values.agencies_id==1469111} width="33%" {else} width="48%" {/if}  align="center"><b>СТРАХУВАЛЬНИК</b></td>
    </tr>
    <tr>
        <td>М.П.</td>
	...
	<tr>
		...
		<br /><br /><br /><br />
			...
			<tr>
				<td colspan=2 align=center>(підпис/МП)</td>
			</tr>
