...
<table cellpadding="5" cellspacing="0" width="100%">
<tr>
	<td width="20%"><b>11. Строк дії періодів страхування за Договором . Страхова сума. Страховий тариф. Страховий платіж та термін його сплати</b></td>
	<td>
		...
		<tr>
			<td width="10%" rowspan="2">№ строку дії періоду (року) страхування</td>
			<td colspan="2">Строк дії періодів (років) страхування</td>
		...
		<tr>
			...
			{/if}	
			<td align="right">{$values.yearsPayments[roll].amount_kasko|moneyformat:-1}{if $values.yearsPayments[roll].doplata}**{/if}</td>
...
<p>При договірному списанні коштів: Банківські реквізити для договірного списання коштів в рахунок оплати чергового страхового платежу з рахунку Страхувальника:<br><br> Рахунок №_______________________ в _______________________________, МФО __________, ЄДРПОУ ____________________.     
	</td>
</tr>
...
<tr>
	<td height="30">{if $values.top_agency_id==557}&nbsp;&nbsp;&nbsp;{elseif $values.ground_kasko && $values.agencies_edrpou != $values.insurer_edrpou}{$values.director1}{else}{if $values.new_director == 1}Директор Щучьєва Т.А.{else}Директор Скрипник О.О.{/if}{/if}</td>
