...
<html>
<head>
	<title>ЗАЯВА на  страхування  від  нещасних  випадків, Кредиагриколь</title>
...
<p><b>5. Страхувальник/Застрахована особа бажає отримати страховий захист за наступними страховими випадками:</b></p>
...
<tr>
	...
	<td><b>8.Територія, час дії Договору страхування в межах проміжку доби: </b></td>
	<td width="200" class="all">Україна, цілодобово</td>
</tr>
</table><br />
...
<p>10. Договір страхування прошу укласти на користь Вигодонабувача:  ТАК<br><br>
<table width="100%" cellspacing="0" cellpadding="5">
<tr>
	<td>Назва, реквізити Вигодонабувача: </td>
	<td width="1000" class="all">Публічне акціонерне товариство «КРЕДІ АГРІКОЛЬ БАНК»
КОД ПЛАТНИКА ПОДАТКІВ ЗГІДНО З ЄДРПОУ 14361575, МФО 300614
</td>
</tr>
<tr>
