...
<tr>
    ...
    <td colspan="3">{if $values.policies_insurer_person_types_id == 1}{$values.policies_insurer_lastname} {$values.policies_insurer_firstname} {$values.policies_insurer_patronymicname}{else}{$values.policies_insurer_company}{/if}</td>
</tr>
<tr>
...
<tr>
    ...
    <td align="center">{if $values.product_document_types.73 !=''}<span>+</span>{else}<b>&mdash;</b>{/if}</td>
</tr>
<tr>
