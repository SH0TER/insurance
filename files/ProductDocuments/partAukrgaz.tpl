...
<table cellpadding="5" cellspacing="0" width="100%">
<tr>
	<td width="20%"><b>11. Страховий тариф. Страховий платіж</b></td>
	<td>
		...
		<tr>
			...
			<td rowspan="2">Страховий платіж, грн.</td>
...
{if $values.agreement_types_id>100}
{if !$values.options_fifty_fifty}
...
<p>4.	Договір страхування є дійсним при наявності всіх частин. Страхувальник має право отримати дублікат Договору страхування або його частин у випадку втрати. Відсутність хоча б однієї з частин свідчить про недійсність Договору страхування.
<br />
