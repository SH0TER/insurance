...
<html>
<head>
	<title>ЗАЯВА на  страхування  від  нещасних  випадків, Кредобанк/Юнисон</title>
...
<table width="100%" cellspacing="0" cellpadding="5">
<tr>
	<td>3. Дата народження:</td>
	<td width="1000" class="all">{$values.insurer_dateofbirth|date_format:$smarty.const.DATE_FORMAT_SMARTY}р.</td>
</tr>
</table><br />
...
<tr>
	...
	<td>Заняття активними видами спорту:</td>
	<td width="200" class="all">{$values.insurer_sport}</td>
</tr>
</table><br />

<p><b>5. Страхувальник/Застрахована особа бажає отримати страховий захист за наступними страховими випадками (необхідне відмітити Х):</b></p>
...
<table cellspacing="0" cellpadding="5" width="100%">
<tr>
	<td><b>6. Страхова сума:</b></td>
	<td width="200" class="all">{$values.price|moneyformat:-1}</td>
	<td><b>7. Період  страхування:</b></td>
	...
	<td><b>8. Територія, період покриття:</b></td>
	<td width="200" class="all">{$values.correct_factors.5}</td>
</tr>
</table><br />

<p><b>9. Існуючі Договори страхування від нещасних випадків:</b></p>
<table cellspacing="0" cellpadding="5" width="100%">
<tr>
...
<table width="100%" cellspacing="0" cellpadding="5">
<tr>
	<td>10. Договір страхування прошу укласти на користь Вигодонабувача:  </td>
	<td  class="all">Так</td>
</tr>
</table><br />
...
<tr>
   ...
   <td width="1000" class="all">
   
    Назва, реквізити Вигодонабувача: <br>
	{if $values.financial_institutions_id==61}
		ПАТ «БАНК ЮНІСОН», КОД ЄДРПОУ 38514375, <br>
		Адреса, телефон Вигодонабувача: 03028, м. Київ, пр-т Науки, 30-А, тел.: (044) 525-25-24<br>
	{else}
		ПАТ «КРЕДОБАНК», код ЄДРПОУ 09807862<br>
		Адреса, телефон Вигодонабувача: 79026, м. Львів, вул. Сахарова, 78, тел.: 0-800-500-8-50<br>
	{/if}	
...
<p>Страхування  здійснюється   на  стандартних  умовах, на  підставі   Правил ТДВ "Експрес Страхування" добровільного страхування від нещасних випадків, зареєстрованих Державною комісією з регулювання ринків фінансових послуг України  23 жовтня 2008 р.
</body>
</html>