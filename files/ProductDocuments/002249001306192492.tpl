...
<html>
<head>
	<title>Службова записка на оплату довідки за послуги компетентних органів ГАИ, КАСКО/ГО</title>
...
<h2>на оплату справки ДАІ по справі № {$values.accidents_number}</h2><br /><br /><br />

<p>Прошу оплатити довідку за послуги компетентних органів по договору {if $values.product_types_id==4}ЦВ{else}КАСКО{/if} № {$values.policies_number} від {$values.policies_date|date_format:$smarty.const.DATE_FORMAT_SMARTY}р. в розмірі:</p>
<p>&nbsp;</p>
