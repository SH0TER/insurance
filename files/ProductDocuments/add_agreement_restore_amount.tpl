...
<br>уклали цю додаткову Угоду № {$values.sub_number}  (далі - «Додаткова угода»)  до  Договору   страхування наземних транспортних засобів № {$values.original.number} від {$values.original.date|date_format:$smarty.const.DATE_FORMAT_SMARTY}р. р. (далі – «Договір страхування»)  про наступне:
<br>
<br><br>
</div>
...
<tr  class=dop>
<td></td>
<td  class=dop>1.1. зменшення страхової суми до: </td>
<td  class="all dop">{$values.original.current_item_price|moneyformat:-1} грн.</td>
</tr>
<tr class=dop>
<td><br></td>
<td></td>
...
<tr class=dop>
<td></td>
<td  class=dop>у зв’язку з виплатою страхового відшкодування в розмірі:</td>
<td  class="left right bottom top dop">{$values.original.payed_amount|moneyformat:-1} грн.</td>
</tr>
<tr class=dop>
<td><br></td>
<td></td>
...
<tr class=dop>
<td></td>
<td  class=dop>1.2. збільшення ринкової (дійсної) вартості транспортного засобу на момент укладання даної Додаткової угоди:  </td>
<td class="left right bottom top dop">{$values.market_price|moneyformat:-1} грн.</td>
</tr>
<tr class=dop>
<td><br></td>
<td></td>
...
<tr class=dop >
<td></td>
<td  class=dop><u><b>збільшити страхову суму за договором страхування</b></u><br> та встановити її в розмірі:</td>
<td class="all">{$values.car_price|moneyformat:-1} грн.</td>
</tr>
...
<tr class=dop>
<td  class=dop>2.</td>
<td  class=dop><u><b>Встановити суму додаткового страхового платежу</b></u> за Договором страхування:</td>
<td  class="all dop">{$values.amount|moneyformat:-1}грн.</td>
</tr>
...
<tr class=dop>
<td  class=dop>3.</td>
<td colspan=2  class=dop><u><b>Викласти частину А Договору страхування  в редакції Додатку 1 до цієї Додаткової угоди.</b></u></td>
</tr>
 <tr class=dop>
<td><br></td>
<td></td>
...
<tr class=dop>
<td  class=dop>4.</td>
<td colspan=2  class=dop><u><b>Викласти частину Б Договору страхування  в редакції Додатку 2 до цієї Додаткової угоди.</b></u></td>
</tr>
...
<tr class=dop>
<td  class=dop>5.</td>
<td colspan=2  class=dop>Ця Додаткова Угода є невід’ємною частиною Договору страхування та набуває чинності з моменту її підписання Сторонами, але не раніше 00 год. 00 хв. дати, наступної за датою надходження додаткового страхового платежу на поточний рахунок Страховика в повному обсязі.</td>
</tr>
...
<tr class=dop>
<td  class=dop>6.</td>
<td colspan=2  class=dop>Інші умови Договору страхування залишаються без змін.</td>
</tr>
...
<tr class=dop>
<td  class=dop>7.</td>
<td colspan=2  class=dop>Дана Додаткова угода складена в 2-х примірниках, які мають однакову юридичну силу, по одному примірнику для кожної із Сторін.</td>
