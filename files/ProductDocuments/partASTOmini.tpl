...
<tr>
	...
	{else}
        <h1>Договір добровільного страхування наземних транспортних засобів  <br> ПРОГРАМА "КАСКО Mini"</h1>
...
<tr>
	<td width="20%"><b>6. Перелік страхових випадків</b> </td>
	<td class="all">
	<b>Дорожньо-транспортна пригода (ДТП):</b> пошкодження та/або знищення застрахованого ТЗ внаслідок події, що сталася під час руху застрахованого ТЗ або іншого ТЗ – учасника події, внаслідок якої загинули або поранені люди чи завдані матеріальні збитки, а саме:
...
<table cellpadding="5" cellspacing="0" width="100%">
<tr>
	<td width="20%" rowspan="4"><b>7. Страхова сума, страховий тариф, страховий платіж, франшиза</b></td>
	<td>&nbsp;</td>
	...
	<td class="top right bottom center"><b>Франшиза безумовна, грн.</b></td>
</tr>
<tr>
	...
	<td class="right bottom" align="right"> 
...
<table cellpadding="5" cellspacing="0" width="100%">
<tr>
	<td width="20%"><b>8. Строк дії Договору</b></td>
	<td class="all">
		...
		<p>8.1. Страховий захист по Договору діє до першого страхового випадку. Перший страховий випадок - це факт звернення Страхувальника до Страховика з Заявою про виплату страхового відшкодування за подією, що згідно з п.6 частини А Договору визнана як страховий випадок. Після здійснення Страховиком виплати страхового відшкодування по першому страховому випадку Договір вважається таким, що закінчив свою дію.
	</td>
</tr>
</table>
<table cellpadding="5" cellspacing="0" width="100%">
<tr>
	<td width="20%"><b>9. Місце дії Договору</b></td>
	<td class="all">Україна</td>
</tr>
</table> 
...
<table cellpadding="5" cellspacing="0" width="100%">
<tr>
	<td width="20%"><b>10. Порядок сплати страхового платежу</b></td>
	<td>
...
<table cellpadding="5" cellspacing="0" width="100%">
    <tr>
        <td width="20%"><b>11. Пріорітет виплат</b></td>
...
<table cellpadding="5" cellspacing="0" width="100%">
    <tr>
        <td width="20%" rowspan="11" valign="top"><b>12. Додаткові опції</b></td>
        <td class="all" width="70%">фізичний знос не вираховується</td>
        <td class="right top bottom" width="10%">ні</td>
    </tr>
    <tr>
        <td class="left right bottom" width="70%">страхування таксі</td>
        <td class="right bottom" width="10%">ні</td>
    </tr>
    <tr>
        <td class="left right bottom" width="70%">виплата страхового відшкодування без надання довідок компетентних органів</td>
        <td class="right bottom" width="10%">ні</td>
    </tr>
	...
	<tr>
		<td class="right bottom left">відшкодування вартості витрат на евакуацію (транспортування) ТЗ, на одне завантаження, розвантаження та перевезення, в межах 500 грн. за страховим випадком</td>
		<td class="right bottom">так</td>
	</tr>
	<tr>
...
<table cellpadding="5" cellspacing="0" width="100%">
	<tr>
		<td width="20%"><b>13. Місце реєстрації ТЗ</b></td>
...
<tr>
	<td height="30">{if $values.ground_kasko && $values.agencies_edrpou != $values.insurer_edrpou}{$values.director1}{else}{if $values.new_director == 1}Директор Щучьєва Т.А.{else}Директор Скрипник О.О.{/if}{/if}<br></td>
	{if $values.agencies_id==560111}<td>Турчина Н.М.</td>{/if}
	{if $values.agencies_id==1469111}<td>Поліщук М. О.</td>{/if}
	<td height="30">{if $values.insurer_position}{$values.insurer_position} {$values.insurer_company} {/if}{$values.insurer_lastname} {$values.insurer_firstname|truncate:2:'':true}. {$values.insurer_patronymicname|truncate:2:'':true}.<br></td>
</tr>
<tr>
...
<tr>
			<td width="50%">{if $values.ukravto == 1 && $values.ground_kasko && $values.agencies_edrpou != $values.insurer_edrpou   && $values.agencies_id!=1469111}{$values.findirector1}{else} {/if}<br></td>
</tr>
<tr>
	<td class="top center">(П.І.Б., підпис)</td>
	{if $values.agencies_id==560111 || $values.agencies_id==1469111}<td></td>{/if}
