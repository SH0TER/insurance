...
<table cellpadding="5" cellspacing="0" width="100%">
	...
	<tr>
		<td class="right bottom left">виплата страхового відшкодування без надання довідок компетентних органів, два рази протягом строку дії Договору, в межах 100 000,00 гривень вартості відновлювального ремонту, виключно шляхом перерахування коштів на рахунок СТО, що підтримує гарантійні зобов’язання виробника (імпортера/офіційного дилера) застрахованого ТЗ та яка письмово погоджена зі Страховиком</td>
