...
<html>
<head>
	<title>Договір добровільного страхування від нещасних випадків, СТАНДАРТ</title>
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<link type="text/css" href="http://{$smarty.server.HTTP_HOST}/css/pdf.css" rel="stylesheet" />
</head>
<body>
<!--<div align="right">
Додаток №1   до Додаткової угоди № __<br><br>
до Договору доручення № СК/1220-50-10 від «10» червня 2012 року<br><br>
Додаток №7  до Договору доручення № СК/1220-50-10 від «10» червня 2012 року
<br><br>
</div>-->
...
<p>5.1.3.	документи, що підтверджують факт та обставини страхового випадку (оригiнали або завiренi вiдповiдними медичними установами або уповноваженим представником Страховика копії):
<ul>
...
<li>копія листка непрацездатності або довідки закладу охорони здоров’я (для непрацюючих), підписані відповідальною особою та завірені печаткою закладу охорони здоров’я (при госпіталізації Страхувальника / Застрахованої особи)
<li>оригінали документів, виданих медико-соціальною експертною комісією (МСЕК), що пiдтверджують встановлення групи iнвалiдностi;
...
<li>результати досліджень на наявність у Страхувальника / Застрахованої особи  в крові алкоголю та/або перебування її під дією наркотичних чи токсичних речовин під час керування транспортним засобом та інших дій, залежно від характеру страхового випадку ;
...
<p>5.1.5.	паспорт та довідка про реєстраційний номер облікової картки платника податків, що отримує страхову виплату;
...
<p>*Документи надаються у разі, якщо у зв’язку з подією, яка призвела до страхового випадку почато / відкрите  кримінальне провадження або закрите кримінальне провадження.
...
<p>5.4.	Будь-які витрати на отримання документів, перелік яких наведено у п. 5.1. Договору страхування, несе Страхувальник (Застрахована особа), спадкоємці. 
...
<p>8.1.5.	оскаржити в судовому порядку рішення Страховика про відмову у здійсненні страхової виплати;
<p>8.1.6.	ініціювати внесення змін до Договору страхування або достроково припинити Договір страхування відповідно до умов, визначених цим Договором страхування, за письмовою згодою Вигодонабувача за умови, якщо Вигодонабучем є Банк.
...
<tr>
	<td width="45%" valign=top>
		...
		<tr>
			<td width="50%">{if ($values.ground_kasko || $values.ground_ns) && $values.agencies_id != 1}{$values.director1}{else}{if $values.new_director == 1}Директор Щучьєва Т.А.{else}Директор Скрипник О.О.{/if}{/if}</td>
			<td class="bottom">&nbsp;</td>
		</tr>
		{if $values.agencies_id==1469 || $values.agencies_id==1496 || $values.agencies_id==1497 || $values.agencies_id==1498}
		<tr>
