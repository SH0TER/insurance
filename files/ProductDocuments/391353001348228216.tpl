...
<html>
<head>
	<title>ЗАЯВА на  страхування  від  нещасних  випадків, Кредит-Днiпро</title>
...
<tr>
    ...
    <td width="1000" class="all">{$values.assured_title}, {if $values.financial_institutions_id == 0}ІПН: {else}ЄДРПОУ: {/if}{$values.assured_identification_code};{if $values.financial_institutions_id != 0} МФО: {$values.assured_mfo}{/if}</td>
</tr>
<tr>
	<td colspan="2">
		<p>Інформація, щодо:
