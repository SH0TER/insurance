...
<html>
<head>
	<title>Договір добровільного страхування від нещасних випадків, Кредобанк Унисон</title>
...
<tr>
	...
	<td class="top right bottom"><b>Страховик</b></td>
		...
		{else}
				 Товариство з додатковою відповідальністю "Експрес Страхування", що є платником податку згідно ст.133 пп.133.1.1 Податкового кодексу України №2755-VI від 02.12.2010 р.,  в особі Директора Щучьєвої Тетяни Андріївни, яка діє на підставі Статуту
		{/if}
		</td>
</tr>
<tr>
...
<tr>
	<td class="all">3.1.</td>
	<td class="top right bottom">{if $values.financial_institutions_id==61}ПАТ «БАНК ЮНІСОН», КОД ЄДРПОУ 38514375, юридична/фактична адреса: 03028, м. Київ, пр-т Науки, 30-А, тел.: (044) 525-25-24{else}ПАТ «КРЕДОБАНК», КОД ЄДРПОУ 09807862, юридична/фактична адреса: 79026, м. Львів, вул. Сахарова, 78, тел.: 0-800-500-8-50{/if}</td>
</tr>
</table><br />
...
<tr>
	...
	<td class="right bottom"> Цей Договір страхування набирає чинностіз 00 год. дати, наступної за датою надходження страхового платежу на розрахунковий рахунок Страховика, але не раніше дати початку строку дії Договору страхування. Цей Договір укладений у 3 (трьох) оригінальних примірниках українською мовою, які мають однакову юридичну силу– по одному для Страховика, Страхувальника та Вигодонабувача.</td>
</tr>
</table><br />
...
<p>3.2.	Нещасний випадок – це раптова, випадкова, короткочасна, не передбачувана та незалежна від волі Страхувальника та Вигодонабувача подія, що фактично відбулася і внаслідок якої настав розлад здоров’я і/або  смерть Страхувальника, а саме: травматичні пошкодження, поранення; випадкове потрапляння в дихальні шляхи чужорідного тіла або рідини; ураження блискавкою і/або електричним струмом; опіки; утоплення; обмороження; переохолодження; укуси тварин,  отруйних комах, змій; випадкове отруєння газами, побутовими або промисловими хімічними речовинами, недоброякісними продуктами харчування, отруйними рослинами, ліками (крім випадків самолікування), захворювання кліщовим енцефалітом, ботулізмом, малярією, правцем, сказом.
...
<p>5.1.1.	Заява про страхову виплату з зазначенням обставин настання та характеру страхового випадку;
<p>5.1.2.	Договору страхування;
<p>5.1.3.	документи, що підтверджують настання страхового випадку:
<ul>
<li>	акт про нещасний випадок на виробництві з детальним описом причин, якi зумовили настання страхового випадку, підписаний керівником або представником підприємства, на якому працює Страхувальник/Застрахована особа, іншою відповідальною особою – при нещасних випадках, що сталися на виробництві (оригiнал або завiрена органом, який видав відповідний документ або уповноваженим представником Страховика копія);
<li>	лікувальний лист або довідка про непрацездатність (у впадку непрацездатності), довідка щодо амбулаторного (стаціонарного) лікування для дітей та непрацюючих (оригiнал або завiрена органом, який видав відповідний документ або уповноваженим представником Страховика копія);
<li>	документи, видані медико-соціальною експертною комісією (МСЕК), що пiдтверджують встановлення групи iнвалiдностi (оригiнал або завiрена органом, який видав відповідний документ або уповноваженим представником Страховика копія);
<li>	інші документи за запитом Страховика, якщо це необхідно для прийняття рішення про настання страхоовго випадку та визначення розміру збитку;
<li>	результати досліджень на наявність алкоголю та наркотиків (якщо Страхувальника/Застраховану особу було направлено на таке дослідження працівниками відповідного компетентного органу)в разі смерті Страхувальника/Застрахованої особи внаслідок нещасного випадку - свідоцтво про смерть Страхувальника/Застрахованої особи (оригiнал або завiрена органом, який видав відповідний документ або уповноваженим представником Страховика копія), копія лікарського свідоцтва про смерть/довідки з медзакладу куди потрапив Страхувальник/Застрахована особа . 
</ul>
<p>5.1.4.	документи про правонаступництво (для Спадкоємців);
<p>5.1.5.	паспорт та довідка про присвоєння ідентифікаційного номеру особи, яка отримує страхову виплату (надається фізичною особою-одержувачем страхового відшкодування);
...
<p>* Документи надаються у разі, якщо у зв’язку з подією, яка призвела до страхового випадку почато/відкрито кримінальне провадження або закрито кримінальне провадження.  
...
<p>8.2.	Страхувальник/Застрахована особа або Вигодонабувач зобов’язані
...
<p>8.2.5.	 повідомити про страховий випадок протягом 3 (трьох) робочих днів з дня його настання,  або з моменту коли стало відомо про настання такої події будь-яким способом, що дозволить об’єктивно зафіксувати факт повідомлення.
...
<p>9.1.3.	несплати Страхувальником страхових платежів у встановлені Договором строки; ліквідації  Страхувальника – юридичної особи або смерті Страхувальника – громадянина чи втрати ним дієздатності, за винятком випадків, передбачених Законом України „Про страхування”;
<p>9.1.4.	ліквідації Страховика у порядку, встановленому законодавством України;
<p>9.1.5.	прийняття судового рішення про визначення Договору страхування недійсним;
<p>9.1.6.	в інших випадках, передбачених законодавством України.
<p>9.2.	Дію Договору страхування може бути достроково припинено за вимогою Страхувальника або Страховика та при письмовій згоді на таке Вигодонабувача. Про намір достроково припинити дію Договору страхування будь-яка сторона зобов’язана повідомити іншу та Вигодонабувача не пізніше, як за 30 календарних днів до дати припинення дії Договору страхування. 
...
<p>9.5.	Зміни до Договору страхування оформлюються за взаємною згодою сторін та Вигодонабувача у вигляді додаткових угод, щоз моменту їх підписання Сторнами стають невідємними частинами  даного Договору страхування.
...
<p>10.7.	Ця згода діє протягом невизначеного строку та не припиняється у зв’язку з закінченням дії цього Договору. Страхувальник має право на пред’явлення  вмотивованої вимоги щодо зміни або знищення своїх персональних даних.
