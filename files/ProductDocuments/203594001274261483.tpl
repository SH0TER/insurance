...
<html>
<head>
	<title>КАСКО. Заявление несколько ТС</title>
...
<table cellspacing=0 cellpadding=5 width="100%">
<tr>
	<td width="20%"><b>7. Додатковi умови договору страхування</b></td>
	<td>
		<p>7.1. Варiант франшизи (за ризиками 4.1. - 4.6. та окремо за ризиком 4.7.):</p>
		<table cellspacing=0 cellpadding=5 width="100%">
		<tr>
		...
		<p>7.4. Територія дії договору страхування:</p>
		<table cellspacing=0 cellpadding=5 width="100%">
		<tr>
...
<table cellspacing=0 cellpadding=5 width="100%">
<tr>
	<td rowspan="11" width="20%"><b>8. Додатковi опцiї</b></td>
...
{/if}
{if $values.retail && $values.agreement_types_id==0}
	<tr>
...
<table cellspacing=0 cellpadding=5 width="100%">
<tr>
	<td><b>9. Договiр страхування прошу укласти на користь Вигодонабувача - {if $values.assured_title}ТАК{else}НI{/if}</b></td>
</tr>
</table>
