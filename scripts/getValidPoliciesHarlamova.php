...
group by a.policies_id HAVING(max(a.date))>=\'2013-09-02\'  ';
...
date_format(getPolicyDate(c.number, 3), \'%d.%m.%Y\') as e_date, h.title as statuses, \'сплачено\' as p_status, j.title as bank, k.title as agency, concat_ws(\' \', l.lastname, l.firstname), getInsurerAddressByPoliciesId(c.id),

getCarParameters(1,e.car_body_id) as car_body_title, getCarParameters(3,e.car_engine_type_id) as car_engine_type_title, getCarParameters(2,e.transmissions_id) as transmissions_title,
c.id
from  temp_list b  
