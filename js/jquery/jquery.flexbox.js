    ...
    $.flexbox = function(div, o) {
        ...
        var $input = $('<input/>')
            ...
            .blur(function(e) {
                ...
                if (o.afterblur != null) o.afterblur($hdn.val());
		...
		function filter(data, params) {
			...
			for (var i=0; i < data[o.resultsProperty].length; i++) {
				...
				if ((o.matchAny && indexOfMatch !== -1) || (!o.matchAny && indexOfMatch === 0)) {
                    if(o.compare != null) {
                        //console.log(data[o.resultsProperty][i].regions_go_id + '   ' + data[o.resultsProperty][i].name)
                        if (o.compare(data[o.resultsProperty][i])) {
