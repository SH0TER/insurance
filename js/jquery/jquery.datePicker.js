...
//					$('.selectee', this.context).focus();
	...
	// localisable text
	$.dpText = {
		TEXT_PREV_YEAR		:	'Попередній рік',
		TEXT_PREV_MONTH		:	'Попередній місяць',
		TEXT_NEXT_YEAR		:	'Наступний рік',
		TEXT_NEXT_MONTH		:	'Наступний місяць',
		TEXT_CLOSE			:	'Закрити',
		TEXT_CHOOSE_DATE	:	'Вибрати дату',
