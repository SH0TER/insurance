...
$i++;
$cfg['Servers'][$i]['host']          = 'mysql.hv-juenemann.com'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'db50376_25';      // MySQL user
$cfg['Servers'][$i]['password']      = 'toyota';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'db50376_25';          // If set to a db-name, only
