...
$fckphp_config['ResourceAreas']['File'] =array(
	...
	'AllowedExtensions'	=>	array("zip","doc","xls","pdf","rtf","csv","jpg","gif","jpeg","png"),
...
/*------------------------------------------------------------------------------*/
$fckphp_config['DiskQuota']['Global']=100; //In MBytes (default: 50mb)
/*==============================================================================*/
...
$fckphp_config['MaxFileNameLength']=100;
...
$fckphp_config['ResourceTypes'] = array('File','Image');
