				...
				<td height="28">
					...
					<tr>
						...
						<td width="100%" align="right">
							<b>Банк:</b>
							<?
                            $financial_institutions=$data['financial_institutions'];
							echo '<select name="financial_institutions_id" onchange="document.'.$this->objectTitle.'.submit()" class="fldSelect" onfocus="this.className=\'fldSelectOver\'" onblur="this.className=\'fldSelect\'">';
                        ...
                        <td width="100%" align="right" nowrap="">
							<b>Розділ:</b> 
							<select name="sections_id" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'" onchange="document.<?=$this->objectTitle?>.submit()">
								<option value="<?=PRODUCT_DOCUMENT_SECTIONS_SALE?>"  <?=($data['sections_id'] == PRODUCT_DOCUMENT_SECTIONS_SALE) ? 'selected' : ''?>>оформлення</option>
								<option value="<?=PRODUCT_DOCUMENT_SECTIONS_SETTLEMENT?>"  <?=($data['sections_id'] == PRODUCT_DOCUMENT_SECTIONS_SETTLEMENT) ? 'selected' : ''?>>врегулювання</option>
							</select>
						</td>
					</tr>
					</table>
