<script>
	...
	function send() {
		$('form[name=<?=$this->objectTitle?>]').attr('action', '<?=$_SERVER["PHP_SELF"]?>?do=Accidents|show&show=kasko');
    ...
    <tr>
        ...
        <td>
                        ...
                        <tr>
                            <td valign="bottom">
                                ...
                                <tr>
                                    ...
                                    <? if ($this->permissions['updateRegres']) echo '<td width="22"><a href="javascript:var b = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action11\'); if (b) b.click();" onMouseOver="var over = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action11\'); if (over) over.over(); return true;" onMouseOut="var out = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action11\'); if (out) out.out(); return true;"><img height="19" width="19" name="'.$this->objectTitle.'Action11" src="/images/administration/navigation/regres.gif" alt="Регрес" /></a></td>'?>
                                    <td width="10"></td>
                            ...
                            <td class="filters" align="right">
                                ...
                                <tr>
                                    ...
                                    <td valign="bottom" rowspan="2">
										<b>СТО:</b>
                                        <select name="car_services_id" class="filter fldSelect" onfocus="this.className='filter fldSelectOver'" onblur="this.className='filter fldSelect'">
                                            <?
                                ...
                                <tr>
									<b>Отримано СК:</b>
                                    <select name="in_express[]" multiple="multiple" size="2" class="filter fldSelect" onfocus="this.className='filter fldSelectOver'" onblur="this.className='filter fldSelect'">
            ...
            <script type="text/javascript">
                ...
                <? if ($this->permissions['updateRegres']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action11\', document.'.$this->objectTitle.', \''.$this->object.'|updateRegres\', \'/images/administration/navigation/regres.gif\', \'/images/administration/navigation/regres_over.gif\', \'\', \'/images/administration/navigation/regres_dim.gif\', true, false, true, true, \'Регрес\', false, \'\');'?>
