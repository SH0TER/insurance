<script>
	...
	function send() {
		$('form[name=<?=$this->objectTitle?>]').attr('action', '<?=$_SERVER["PHP_SELF"]?>?do=Accidents|show&show=property');
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <td class="filters" align="right">
                                ...
                                <tr>                                    
                                    <td><b>Категорія:</b> <?=$fields['accident_sections_id']['object']?></td>
                                    <td><b>Компанія:</b> <?=$fields['companies_id']['object']?></td>
                                    <td>
                                        <b>Архів:</b>
                                    ...
                                    <td><b>Статус:</b> <?=$fields['accident_statuses_id']['object']?></td>
									<td><b>Аварком:</b>
                                        ...
                                        <?
                                            foreach ($fields['average_managers'] as $row) {
                                ...
                                <tr>
                                    <!--td colspan="2"><b>Вид страхування:</b>
									...
									<td><b>Держ. номер:</b> <input type="text" name="sign" value="<?=$data['sign']?>" class="filter fldText number" onfocus="this.className='filter fldTextOver number';" onblur="this.className='filter fldText number';" /></td>
								</tr>
								<tr>                              
									<td colspan="3">
									<td colspan="2">
                ...
                <tr>
                    <td id="block<?=$this->object?>Table">
                        ...
                        <tr class="<?=$this->getRowClass($row, $i)?>">
                            ...
                            <td valign="middle"><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['number']?>&nbsp;<? /*if($row['circle_label'] == 1) echo '<img src="/images/agree.gif"'; */?></a></td>
