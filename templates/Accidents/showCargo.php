<script>
	...
	function send() {
		$('form[name=<?=$this->objectTitle?>]').attr('action', '<?=$_SERVER["PHP_SELF"]?>?do=Accidents|show&show=cargo');
    ...
    <tr>
        ...
        <td>
                        ...
                        <tr>
                            <td valign="bottom">
                                ...
                                <tr>
                                    ...
                                    <? if ($this->permissions['updateClassification']) echo '<td width="22"><a href="javascript:var b = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action10\'); if (b) b.click();" onMouseOver="var over = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action10\'); if (over) over.over(); return true;" onMouseOut="var out = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action10\'); if (out) out.out(); return true;"><img height="19" width="19" name="'.$this->objectTitle.'Action10" src="/images/administration/navigation/change_persons.gif" alt="Змінити відповідальних" /></a></td>'?>
                                    <td width="10"></td>
                            ...
                            <td align="right">
                                ...
                                <tr>
                                    ...
                                    <td align="right"><b>Держ. номер:</b> <input type="text" name="sign" value="<?=$data['sign']?>" class="fldText number" onfocus="this.className='fldTextOver number';" onblur="this.className='fldText number';" /></td>
                                    <td valign="bottom" rowspan="2"></td>
                                    <td valign="bottom" rowspan="2">

                                    </td>
                                    <td valign="bottom" rowspan="2">
                                    <td><b>№ шасі (кузов, рама):</b> <input type="text" name="shassi" value="<?=$data['shassi']?>" class="fldText number" onfocus="this.className='fldTextOver number';" onblur="this.className='fldText number';" /></td>
                                    </td>
                                ...
                                <tr>
									<b>Отримано СК:</b>
                                    <select name="in_express[]" multiple="multiple" size="2" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'">
                                        <option value="1" <?=(is_array($data['in_express']) && in_array(1, $data['in_express'])) ? 'selected' : ''?>>так</option>
                                        <option value="0" <?=(is_array($data['in_express']) && in_array(0, $data['in_express'])) ? 'selected' : ''?>>ні</option>
                                    </select>
                                    <b>Архів:</b>
                                    <select name="archive_statuses_id[]" multiple="multiple" size="2" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'">
                                    ...
                                    <b>Клас ремонту:</b>
                                    <select name="repair_classifications_id[]" multiple="multiple" size="3" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'">
                                    ...
                                    <b>Аварком:</b>
                                        <select name="average_managers_id[]" multiple="multiple" size="3" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'">
                                            <?
                                            foreach ($fields['average_managers'] as $id=>$value) {
                                                echo '<option value="' . $id . '" ' . (in_array($id, $data['average_managers_id']) ? 'selected' : '') . '>' . $value . '</option>';
                                            }
                                            ?>
                                        </select>
                                </tr>
                                ...
                                <table cellpadding="0" cellspacing="5">
                                <tr>
                                    <td><b>Справа:</b><input type="text" name="number" value="<?=$data['number']?>" class="fldText number" onfocus="this.className='fldTextOver number';" onblur="this.className='fldText number';" /></td>
                                    <td><b>Поліс:</b> <input type="text" name="policies_number" value="<?=$data['policies_number']?>" class="fldAuth" onfocus="this.className='fldAuthOver';" onblur="this.className='fldAuth';" /></td>
                ...
                <tr>
                    <td>
                        ...
                        <tr class="<?=$this->getRowClass($row, $i)?>">
                            ...
                            <td><a href="<?=$_SERVER['PHP_SELF'] . '?do=Policies|view&amp;id=' . $row['policies_id'] . '&product_types_id=' . $row['product_types_id']?>" target="_blank"><?=$row['policies_number']?><?if($row['important_person'] == 1){?>  <b style="color: red;">VIP</b><?}?></a></td>
                            <td style="white-space:normal;"><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['insurer_company']?></a></td>
            ...
            <script type="text/javascript">
                ...
                <? if ($this->permissions['updateClassification']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action10\', document.'.$this->objectTitle.', \''.$this->object.'|loadChangeResponsible\', \'/images/administration/navigation/change_persons.gif\', \'/images/administration/navigation/change_persons_over.gif\', \'\', \'/images/administration/navigation/change_persons_dim.gif\', true, false, true, true, \'Змінити відповідальних\', false, \'\');'?>
