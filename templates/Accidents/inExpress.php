<div class="block">
    <table width="100%" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="caption">Зміна статусу наявності справи:</td>
        </tr>
        <tr>
            <td></td>
            <td>
                    ...
                    <tr>
                        <td>
                            <form name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="do" value="<?=$this->object.'|updateStateInExpress'?>" />
								<?
									if (is_array($data['id'])) {
                                ...
                                <table cellpadding="2" cellspacing="0" width="100%">
                                    <tr>
										<td class="label">*Статус наявності справи:</td>
										<td>
											<select name="in_express" class="fldSelect" onfocus="this.className='fldSelectOver '" onblur="this.className='fldSelect'">
												<option value="0" <?=($data['in_express'] == '0') ? 'selected' : ''?>>Євро Ассістанс</option>
												<option value="1" <?=($data['in_express'] == '1') ? 'selected' : ''?>>Експрес Страхування</option>
											</select>
										</td>
									</tr>
                                    <tr>
