                        ...
                        <td>
                            <form id="<?=$this->objectTitle?>" name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
								...
								<td >
                                    ...
                                    <tr>
                                        <td width="150">&nbsp;</td>
                                        <td align="center"><input type="submit" value=" Виконати " class="button" onMouseOver="this.className = 'buttonOver';" onMouseOut="this.className = 'button';" />   <input id="excel" type="hidden" value="1" name="excel"></td>
                                    </tr>
                                </table>
                            </form>
