                ...
                <?
                {
                    ...
                    while($res->fetchInto($row)) {
						if (intval($row['accident_messages_id'])) {
							...
							$row['result_calculation_car_services_title'] = $answer['result_calculation_car_services_title'];
							$row['amount_repair'] = roundNumber($answer['amount_details'] + $answer['amount_material'] + $answer['amount_work'], 2);
