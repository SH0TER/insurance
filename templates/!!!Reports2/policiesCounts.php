<div class="block">
    <table width="100%" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="caption">Отчет по страховым продуктам:</td>
        </tr>
        <tr>
            <td></td>
            <td>
                ...
                <form name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                    <input type="hidden" name="do" value="Reports|getProdCounts" />
                ...
                <script type="text/javascript">
                    ...
                    <?='document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action0\', document.'.$this->objectTitle.', \''.$this->object.'|getProdCountsInWindow\', \'/images/administration/navigation/export.gif\', \'/images/administration/navigation/export_over.gif\', \'\', \'/images/administration/navigation/export_dim.gif\', true, true, true, true, \'' . translate('Export') . '\', false, \'\');'?>
