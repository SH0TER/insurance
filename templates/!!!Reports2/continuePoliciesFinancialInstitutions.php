<div class="block">
    <table width="100%" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="caption">КАСКО, пролонгація по банкам:</td>
        </tr>
        <tr>
            <td></td>
            <td>
                ...
                <form name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                    <input type="hidden" name="do" value="Reports|getContinuePoliciesFinancialInstitutions" />
					<input type="hidden" name="report" value="getContinuePoliciesFinancialInstitutions" />
