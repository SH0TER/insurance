				...
				<td height="28">
					...
					<tr>
						...
						<td align="right">
							...
							<tr>
								<? if ($Authorization->data['roles_id'] != ROLES_AGENT || $Authorization->data['agencies_id'] == 1) {?>
								<td><b>Агенція:</b></td>
								<td>
									<select name="agencies_id" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'">
										<option value="">...
										<?
											if (is_array($data['agencies'])) {
												foreach ($data['agencies'] as $row) {
													echo '<option value="' . $row['id'] . '" ' . ($data['agencies_id'] == $row['id'] ? 'selected' : '') . '>' . $row['title'];
												}
											}
										?>
									</select>
								...
								<td><b>Банк:</b></td>
								<td>
									<select name="financial_institutions_id" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'">
										<option value="">...
										<?
											if (is_array($data['financial_institutions'])) {
												foreach ($data['financial_institutions'] as $row) {
													echo '<option value="' . $row['id'] . '" ' . ($data['financial_institutions_id'] == $row['id'] ? 'selected' : '') . '>' . $row['title'];
												}
											}
										?>
									</select>
							...
							<tr>
                                ...
                                <td>
                                    ...
                                    <tr>
                            			...
                            			<td><b>Дата кредитного договору:</b></td>
                                		<td>&nbsp;з <input type="text" id="from" name="from" value="<?=$data['from']?>" class="fldDatePicker" onfocus="this.className='fldDatePickerOver';" onblur="this.className='fldDatePicker';" /></td>
        								<td>&nbsp;по <input type="text" id="to" name="to" value="<?=$data['to']?>" class="fldDatePicker" onfocus="this.className='fldDatePickerOver';" onblur="this.className='fldDatePicker';" /></td>
                                     </tr>
                                     </table>
                                    ...
                                    <tr>
        								...
        								<td><b>ЄРДПОУ:</b></td>
                						<td><input type="text" name="edrpou" value="<?=$data['edrpou']?>" class="fldText code" onfocus="this.className='fldTextOver code';" onblur="this.className='fldText code';" /></td>
                                    </tr>
                                    </table>
                                 </td>
