                        ...
                        <td>
                            <form name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                                ...
                                <table cellpadding="2" cellspacing="0" width="100%">
                                    ...
                                    <?
										if ($action != 'view') {
											echo ReinsuranceAgreementDeductibles::getList($data, PRODUCT_TYPES_KASKO);
											echo ReinsuranceAgreementCarYears::getList($data, PRODUCT_TYPES_KASKO);
											echo ReinsuranceAgreementRisks::getList($data, PRODUCT_TYPES_KASKO);
										}
                                    ?>
                                    <tr>
                                        <td width="150">&nbsp;</td>
