<div class="block">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="do" value="CarServices|show" />
			...
			<tr>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="5">
                        <tr>
                            <td><b>Назва:</b> <input type="text" name="title" value="<?=$data['title']?>" class="fldText" onfocus="this.className='fldTextOver';" onblur="this.className='fldText';" /></td>
                        </tr>
                        <tr>
