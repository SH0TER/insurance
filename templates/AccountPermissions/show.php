						...
						<td align="right" valign="bottom">
							<table cellpadding="0" cellspacing="5">
								<tr>
									<td>
										<b>Об'єкт:</b> 
										<select name="object" class="fldSelect" onfocus="this.className='fldSelectOver';" onblur="this.className='fldSelect';">
											<option value="">...
											<? foreach ($data['objects'] as $object) {?>
											<option value="<?=$object?>" <?=($object == $data['object']) ? ' selected' :''?>><?=$object?>
											<? } ?>
										</select>
									</td>
