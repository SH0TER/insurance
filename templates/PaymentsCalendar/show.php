<div class="block">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="do" value="PaymentsCalendar|show" />
				...
				<table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="right">
											...
											<tr>
													<td><b>Отримувач:</b> <input type="text" name="contragent" style="width:120px" value="<?=$data['contragent']?>" class="fldText lastname" onfocus="this.className='fldTextOver lastname';" onblur="this.className='fldText lastname';" /></td>
													<td><b>IПН/ЕДРПОУ:</b> <input type="text" name="code" style="width:60px" value="<?=$data['code']?>" class="fldText lastname" onfocus="this.className='fldTextOver lastname';" onblur="this.className='fldText lastname';" /></td>
													<td><b>Тип платежу:</b> <?=$fields['payment_types_id']['object']?></td>
