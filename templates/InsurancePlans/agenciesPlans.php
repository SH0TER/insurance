...
<tr>
	...
	<td class="caption">Плани по агенциям:</td>
</tr>
<tr>
	<td></td>
	<td>
		...
		<tr>
			<td>
				...
				<input type="hidden" id="doval" name="do" value="<?=$this->object.'|export'?>" />
                ...
                <tr>
					<td class="label">Завантажити останнiй план по агенциям:</td>
...
$('#<?=$this->objectTitle?>').submit(function() {
  ...
  if ($('#lastplan').attr('checked'))
	$('#doval').val('<?=$this->object.'|exportInWindow'?>');
  else
	$('#doval').val('<?=$this->object.'|export'?>');
  return true;
});
</script>
