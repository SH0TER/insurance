			...
			<tr>
                ...
                <td align="right">
                    <table cellpadding="0" cellspacing="5">
                        <tr>
                            <td><b>Номер акту:</b> <input type="text" name="number" size="3" value="<?=$data['number']?>" class="fldText" onfocus="this.className='fldTextOver';" onblur="this.className='fldText';" /></td>
                            ...
                            <td colspan="6" align="right">&nbsp;<input type="submit" value="Показати" class="button" onMouseOver="this.className = 'buttonOver';" onMouseOut="this.className = 'button';" /></td>
                        </tr>
                    </table>
                </td>
			</tr>
