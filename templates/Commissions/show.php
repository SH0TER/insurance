<script>
    function sendCommissionForm(pathForm, objectName, orderPosition, defaultOrderDirection) {
        ...
        <tr>
            ...
            <td>
                ...
                <form name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                    <input type="hidden" name="do" value="Commissions|show" />
                    ...
                    <input type="hidden" name="redirect" value="<?=$_SERVER['PHP_SELF'] . '?do=ProductTypes|show&menu=main&subMenu=Products'?>" />
                    <input type="hidden" name="menu" value="main" />
                    <input type="hidden" name="subMenu" value="Desktop" />
                                            ...
                                            <td align="right">
                                                <table cellpadding="0" cellspacing="5">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <b>Агенція:</b>
                                                            <select name="agencie_id">
                                                                <?
                                                                    foreach ($list_agencies as $agencies) {
                                                                        foreach ($agencies as $agencie) {
                                                                            ?>
                                                                            <option <?
                                                                            if ($agencie['id'] == $data['agencie_id']) echo 'selected'; ?>
                                                                                value="<?= $agencie['id'] ?>"><? if (floatval($agencie['code']) && intval($agencie['code']) != floatval($agencie['code'])) echo '&nbsp;&nbsp;&nbsp;'; ?><?= $agencie['code'] ?>
                                                                                | <?= $agencie['title'] ?></option>
                                                                            <?
                                                                        }
                                                                    }
                                                                ?>
                                                        ...
                                                        <td>&nbsp;<a href="javascript: document.Commissions.submit()">Показати</a></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
