...
<tr>
	...
	<td>{if $values.person_types_id==1}{$values.insurer_lastname} {$values.insurer_firstname} {$values.insurer_patronymicname}{else}{$values.insurer_company}{/if}</td>
</tr>
</table><br />
...
<tr>
	<td>
		{$values.number},
		{if $values.person_types_id==1}{$values.insurer_lastname} {$values.insurer_firstname|truncate:2:'':true}.{$values.insurer_patronymicname|truncate:2:'':true}.{else}{$values.insurer}{/if},
		{if $values.person_types_id==1}{$values.insurer_identification_code}{else}{$values.insurer_edrpou}{/if},
