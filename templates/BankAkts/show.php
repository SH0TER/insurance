<div class="block">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="do" value="BankAkts|show" />
            <input type="hidden" name="redirect" value="index.php?do=BankAkts|show&agent_name=<?=$data['agent_name']?>&agreement_number=<?=$data['agreement_number']?>&number=<?=$data['number']?>" />
				...
				<table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="right">
											...
											<tr>
													<td><b>Фiн установа:</b> <input type="text" name="agent_name" style="width:120px" value="<?=$data['agent_name']?>" class="fldText lastname" onfocus="this.className='fldTextOver lastname';" onblur="this.className='fldText lastname';" /></td>
