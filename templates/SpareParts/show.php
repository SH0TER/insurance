<?
	...
	$spare_part_groups = SparePartGroups::getList();
...
<div class="block">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="do" value="SpareParts|show" />
				...
				<td align="right">
					<table cellpadding="0" cellspacing="5">
						<tr>
							<td><b>Група:</b></td>
							<td>
								<select name="spare_part_groups_id" class="fldSelect" onblur="this.className='fldSelect'" onfocus="this.className='fldSelectOver'">
									<?
										echo '<option value="0">...</option>';
										foreach ($spare_part_groups as $spare_part_group) {
											echo '<option value="' . $spare_part_group['id'] . '" ' . ($spare_part_group['id'] == $data['spare_part_groups_id'] ? 'selected' : '') . '>' . $spare_part_group['title'] . '</option>';
										}
									?>
								</select>
							</td>
