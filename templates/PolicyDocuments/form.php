...
<?if (!ereg('^view', $action) && ($Authorization->data['permissions']['Policies_KASKO']['superupdate'] || $Authorization->data['roles_id']==ROLES_ADMINISTRATOR || $Authorization->data['id']==1 || $Authorization->data['id']==3526)) {?>
<script>
function saveDocContent() {
		var product_document_types_id = getElementValue('product_document_types_id');
		if (product_document_types_id ==31 || product_document_types_id ==82 || product_document_types_id ==83 || product_document_types_id ==1 || product_document_types_id==2 || product_document_types_id==68|| product_document_types_id==171 || product_document_types_id==172 || product_document_types_id==175|| product_document_types_id==70|| product_document_types_id==44 || product_document_types_id==66 || product_document_types_id==28 || product_document_types_id==29 || product_document_types_id==180) {
