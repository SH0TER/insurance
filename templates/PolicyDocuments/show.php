<?=(is_object($data['policies'])) ? $data['policies']->header($data) : ''?>
<div class="block">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="do" value="<?=$data['policies']->object?>|loadStatus" />
			...
			<tr>
				<td height="28">
					...
					<tr>
						...
						<? if ($this->permissions['letterAddPaymentKasko']) echo '<td width="22"><a href="javascript:var b = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'LetterAddPaymentKasko\'); if (b) b.click();" onMouseOver="var over = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'LetterAddPaymentKasko\'); if (over) over.over(); return true;" onMouseOut="var out = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'LetterAddPaymentKasko\'); if (out) out.out(); return true;"><img height="19" width="19" name="'.$this->objectTitle.'LetterAddPaymentKasko" src="/images/administration/navigation/export.gif" alt="Лист" /></a></td>'?>
						<td width="10"></td>
			...
			<!--
				...
				<? if ($this->permissions['change']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action4\', document.'.$this->objectTitle.', \''.$this->object.'|change\', \'/images/administration/navigation/change.gif\', \'/images/administration/navigation/change_over.gif\', \'\', \'/images/administration/navigation/change_dim.gif\', true, false, true, true, \'Регенерувати\', true, \'Ви дійсно бажаєте регенерувати вибранні документи?\');'?>
				...
				<? if ($this->permissions['letterAddPaymentKasko']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'LetterAddPaymentKasko\', document.'.$this->objectTitle.', \''.$this->object.'|letterAddPaymentKaskoInWindow\', \'/images/administration/navigation/export.gif\', \'/images/administration/navigation/export_over.gif\', \'\', \'/images/administration/navigation/export_dim.gif\', true, true, true, true, \'Лист\', false, \'\');'?>
...
<?=(is_object($data['policies'])) ? $data['policies']->footer($data, true, $this->objectTitle) : ''?>