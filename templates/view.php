                    ...
                    <tr><td>
                            <form name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                        <td width="150">&nbsp;</td>
                                        <td align="center"><input type="button" value=" <?=translate('Back')?> " class="button" onclick="changeLocation(document.path, '<?=(sizeOf($_SESSION['auth']['path']) - 2)?>')" onMouseOver="this.className = 'buttonOver';" onMouseOut="this.className = 'button';" /></td>
                                    </tr>
                                </table>
                            </form>
                    </td></tr>
