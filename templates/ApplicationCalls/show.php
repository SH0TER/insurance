<script>
	...
	function send() {
		$('form[name=<?=$this->objectTitle?>]').attr('action', '<?=$_SERVER["PHP_SELF"]?>?do=Accidents|show&show=calls');
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <table>
                                            <tr>
												<td class="label grey"><b>Дата настання пригоди:</b></td>
												<td><b>з</b></td><td><input type="text" id="from_accidents_date" name="from_accidents_date" value="<?=$data['from_accidents_date']?>" class="filter fldDatePicker" onfocus="this.className='filter fldDatePickerOver';" onblur="this.className='filter fldDatePicker';" /></td>
												<td><b>по</b></td><td><input type="text" id="to_accidents_date" name="to_accidents_date" value="<?=$data['to_accidents_date']?>" class="filter fldDatePicker" onfocus="this.className='filter fldDatePickerOver';" onblur="this.className='filter fldDatePicker';" /></td>
												<td class="label grey"><b>Дата реєстрації:</b></td>
												<td><b>з</b></td><td><input type="text" id="from_call_date" name="from_call_date" value="<?=$data['from_call_date']?>" class="filter fldDatePicker" onfocus="this.className='filter fldDatePickerOver';" onblur="this.className='filter fldDatePicker';" /></td>
												<td><b>по</b></td><td><input type="text" id="to_call_date" name="to_call_date" value="<?=$data['to_call_date']?>" class="filter fldDatePicker" onfocus="this.className='filter fldDatePickerOver';" onblur="this.className='filter fldDatePicker';" /></td>
                                                ...
                                                <td><b>Договір КАСКО:</b>
                                                    <input type="text" name="policies_kasko_number" value="<?=$data['policies_kasko_number']?>" class="filter fldAuth" onfocus="this.className='filter fldAuthOver';" onblur="this.className='filter fldAuth';" />
                                                </td>
                                                <td><b>Поліс ОСЦПВ:</b>
                                                    <input type="text" name="policies_go_number" value="<?=$data['policies_go_number']?>" class="filter fldAuth" onfocus="this.className='filter fldAuthOver';" onblur="this.className='filter fldAuth';" />
                                                </td>
                                            </tr>
                                            <tr>
				...
				<td id="block<?=$this->object?>Table">
					<? if ($total) {?>
						...
						<tr class="<?=$this->getRowClass($row, $i)?>">
                            ...
                            <td><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['policies_kasko_number']?></a></td>
                            <td><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['policies_go_number']?></a></td>
                            ...
                            <td><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['car_brands_id']?></a></td>
                            <td><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['car_models_id']?></a></td>
                            ...
                            <td><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['address']?></a></td>
                            ...
                            <td><a href="<?=$_SERVER['PHP_SELF'] . '?do=' . $this->object . '|view&amp;id=' . $row['id'] . '&amp;offset' . $this->object . 'Block=' . $_REQUEST['offset'.$this->object.'Block'] . '&amp;total' . $this->object . 'Block=' . $total . $this->getHiddenFields($hidden)?>"><?=$row['manager']?></a></td>
