...
<div class="block">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="do" value="<?=$data['policies']->object?>|changeStep" />
            ...
            <input type="hidden" name="insurer_person_types_id" value="<?=$data['insurer_person_types_id']?>" />
			...
			<!--
				...
				<? if ($this->permissions['insert']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action0\', document.'.$this->objectTitle.', \'Policies|addObject\', \'/images/administration/navigation/add.gif\', \'/images/administration/navigation/add_over.gif\', \'\', \'/images/administration/navigation/add_dim.gif\', ' . (($total>0) ? 'false' : 'true') .', ' . (($total>0) ? 'false' : 'true') .', ' . (($total>0) ? 'false' : 'true') . ', true, \'' . translate('Add') . '\', false, \'\');'?>
				<? if ($this->permissions['update']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action1\', document.'.$this->objectTitle.', \'Policies|updateObject\', \'/images/administration/navigation/edit.gif\', \'/images/administration/navigation/edit_over.gif\', \'\', \'/images/administration/navigation/edit_dim.gif\', true, false, true, false, \'' . translate('Edit') . '\', false, \'\');'?>
