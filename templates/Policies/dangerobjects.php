<script type="text/javascript">
	...
	function setInsurerIdCard() {
    	if($('[name=insurer_id_card]:checked').val() == 0) {
    		$('table#passportDANGEROBJECTS').show();
    		$('table#insurer_new_passport_table').hide();
    	} else {
    		$('table#passportDANGEROBJECTS').hide();
    ...
    <table cellpadding="2" cellspacing="3" width="100%">
        <tr>
            <td>
				...
				<table class="personBlock" cellpadding="5" cellspacing="0" id="passportDANGEROBJECTS" <?= (intval($data['insurer_id_card'])?'style="display:none"':'') ?>>
				<tr>
