...
<tr>
	...
	<td class="caption">Штрих коди документiв:</td>
</tr>
<tr>
	<td></td>
	<td>
		...
		<tr>
			<td>
				...
				<input type="hidden" name="do" value="<?=$this->object.'|updateDocuments'?>" />
				...
				<tr>
					<td class="label">*Штрих код:</td>
					<td><input type="text" id="barcode" name="barcode" class="fldText" /></td>
				</tr>
				<tr>
					<td width="150">&nbsp;</td>
...
<script type="text/javascript">initFocus(document.<?=$this->objectTitle?>);document.<?=$this->objectTitle?>.barcode.focus()</script>