<script type="text/javascript">
	...
	function setInsurerIdCard() {
    	if($('[name=insurer_id_card]:checked').val() == 0) {
    		$('table#passportTHIRDPARTYLIABILITYPROFRESP').show();
    		$('table#insurer_new_passport_table').hide();
    	} else {
    		$('table#passportTHIRDPARTYLIABILITYPROFRESP').hide();
    ...
    <table cellpadding="2" cellspacing="3" width="100%">
        <tr>
            <td>
				...
				<table class="personBlock" cellpadding="5" cellspacing="0" id="passportTHIRDPARTYLIABILITYPROFRESP" <?= (intval($data['insurer_id_card'])?'style="display:none"':'') ?>>
					<tr>
                ...
                <tr>
					...
					<input type="text" id="deductibles_value" name="deductibles_value" value="<?=$data['deductibles_value']?>" maxlength="10" class="fldInteger" onfocus="this.className='fldIntegerOver';" onblur="this.className='fldInteger';"   <?=$this->getReadonly(true)?>/>
