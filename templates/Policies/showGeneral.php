	...
	<tr>
		...
		<td>
					...
					<tr>
						<td valign="bottom">
							...
							<tr>
								...
								<? if ($this->permissions['payments']) echo '<td width="22"><a href="javascript:var b = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action7\'); if (b) b.click();" onMouseOver="var over = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action7\'); if (over) over.over(); return true;" onMouseOut="var out = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action7\'); if (out) out.out(); return true;"><img height="19" width="19" name="'.$this->objectTitle.'Action7" src="/images/administration/navigation/payments.gif" alt="' . translate('Payments') . '" /></a></td>'?>
								<? if ($this->permissions['importCertificates']) echo '<td width="22"><a href="javascript:var b = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action8\'); if (b) b.click();" onMouseOver="var over = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action8\'); if (over) over.over(); return true;" onMouseOut="var out = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action8\'); if (out) out.out(); return true;"><img height="19" width="19" name="'.$this->objectTitle.'Action8" src="/images/administration/navigation/import.gif" alt="Імпорт" /></a></td>'?>
								<td width="10"></td>
							...
							<tr>
                                <td>
                                    ...
                                    <select name="product_types_id" class="fldSelect" onfocus="this.className='fldSelectOver'" onblur="this.className='fldSelect'">
                                        ...
                                        <? if ($Authorization->data['top_agencies_id'] == 556 || $Authorization->data['roles_id'] != ROLES_AGENT) { ?><option value="10" <?=($data['product_types_id'] == 10) ? 'selected' : ''?>>Генеральні договори добровільного страхування наземних ТЗ</option><? } ?>
                                        <option value="4" <?=($data['product_types_id'] == 4) ? 'selected' : ''?>>ОСЦПВ</option>
                                        <?if ($Authorization->data['top_agencies_id'] != 417 && $Authorization->data['top_agencies_id'] != 1254) {?>
                                        ...
                                        <?}?>
                                        <option value="13" <?=($data['product_types_id'] == 13) ? 'selected' : ''?>><?=$Authorization->data['top_agencies_id'] == 417 ? 'Страхування життя' : 'Cтрахування від нещасних випадків'?></option>
                                    </select>-->
                                </td>
			...
			<!--
				...
				<? if ($this->permissions['payments']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action7\', document.'.$this->objectTitle.', \''.$this->object.'|updatePayments\', \'/images/administration/navigation/payments.gif\', \'/images/administration/navigation/payments_over.gif\', \'\', \'/images/administration/navigation/payments_dim.gif\', true, true, true, true, \'' . translate('Payments') . '\', false, \'\');'?>
				<? if ($this->permissions['importCertificates']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action8\', document.'.$this->objectTitle.', \''.$this->object.'|importCertificates\', \'/images/administration/navigation/import.gif\', \'/images/administration/navigation/import_over.gif\', \'\', \'/images/administration/navigation/import_dim.gif\', true, true, true, true, \'Імпорт\', false, \'\');'?>
