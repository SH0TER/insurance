<div class="block">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="do" value="ProductTypes|view" />
			<input type="hidden" name="filtertitle" value="<?=$data['title']?>" />
			...
			<tr>
				<td height="28">
					...
					<tr>
						...
						<? if ($this->permissions['copy']) echo '<td width="22"><a href="javascript:var b = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action1\'); if (b) b.click();" onMouseOver="var over = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action1\'); if (over) over.over(); return true;" onMouseOut="var out = MM_getButtonWithName(document.'.$this->objectTitle.', \''.$this->objectTitle.'Action1\'); if (out) out.out(); return true;"><img height="19" width="19" name="'.$this->objectTitle.'Action1" src="/images/administration/navigation/copy.gif" alt="' . translate('Copy') . '" /></a></td>'?>
				...
				<td>
					<table align="right" cellpadding="0" cellspacing="5">
                        <tr>
                            <td><b>Назва:</b></td><td><input type="text" name="title" value="<?=$data['title']?>" class="fldText" onfocus="this.className='fldTextOver';" onblur="this.className='fldText';" /></td>
                            <td><input type="submit" value="Показати" class="button"></td>
                        </tr>
                    </table>
				</td>
			</tr>
			...
			<!--
				...
				<? if ($this->permissions['copy']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action1\', document.'.$this->objectTitle.', \''.$this->object.'|copy\', \'/images/administration/navigation/copy.gif\', \'/images/administration/navigation/copy_over.gif\', \'\', \'/images/administration/navigation/copy_dim.gif\', true, false, true, false, \'' . translate('Copy') . '\', false, \'\');'?>
				...
				<? if ($this->permissions['import']) echo 'document.'.$this->objectTitle.'.buttons[document.'.$this->objectTitle.'.buttons.length] = new MMCommandButton(\''.$this->objectTitle.'Action8\', document.'.$this->objectTitle.', \''.$this->object.'|import\', \'/images/administration/navigation/import.gif\', \'/images/administration/navigation/import_over.gif\', \'\', \'/images/administration/navigation/import_dim.gif\', true, true, true, true, \'' . translate('Import') . '\', false, \'\');'?>
