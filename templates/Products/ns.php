                        ...
                        <td>
                            <form name="<?=$this->objectTitle?>" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
								...
								//if ($action != 'view') {
                                    ...
                                    echo ParametersNS::getList($data, PRODUCT_CORRECTION_FACTORS_TYPES_LOCATION);
                                    echo ParametersNS::getList($data, PRODUCT_CORRECTION_FACTORS_TYPES_SPORTS);
                                    echo ParametersNS::getList($data, PRODUCT_CORRECTION_FACTORS_TYPES_PROFESSIONS);
                                    echo ParametersNS::getList($data, PRODUCT_CORRECTION_FACTORS_TYPES_AGES);
                                    echo ParametersNS::getList($data, PRODUCT_CORRECTION_FACTORS_TYPES_TERMS_HOURS);
								//}
								?>
								<tr>
									<td width="150">&nbsp;</td>
