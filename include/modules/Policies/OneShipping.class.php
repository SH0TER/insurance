...
class Policies_OneShipping extends Policies {
                    ...
                    array(
                       ...
                       /*array(
                        ...
                        array(
                            ...
                            'type'              => fldText,
                            'maxlength'         => 13,
                            'validationRule'	=> '502.[0-9][0-9].[0-9]{6}',
                            'display'           =>
                                array(
                                    'show'      => false,
                                    'insert'    => true,
						...
						array(
                            ...
                            'description'       => 'Вигодонабувач, банкiвський рахунок',
                            'type'              => fldText,
							'maxlength'			=> 14,
							'validationRule'	=> '^([0-9]{9,14})$',
                            'display'           =>
						...
						array(
                            'name'              => 'place1',
                            'description'       => 'Місце завантаження (адреса)',
                            'type'              => fldText,
                            'maxlength'         => 200,
                            'display'           =>
                                array(
							...
							array(
                            'name'              => 'place2',
                            'description'       => 'Місце розвантаження (адреса)',
                            'type'              => fldText,
                            'maxlength'         => 200,
                            'display'           =>
                                array(
							...
							array(
                            'name'              => 'place3',
                            'description'       => 'Місця перевантаження, проміжного зберігання, складування',
                            'type'              => fldText,
                            'maxlength'         => 200,
                            'display'           =>
                                array(
						...
						array(
                            'name'              => 'packaging',
                            'description'       => 'Упаковка, кріплення',
                            'type'              => fldText,
                            'maxlength'         => 150,
                            'display'           =>
                                array(
                            ...
                            'table'             => 'policies_one_shipping'),
						array(
                            'name'              => 'documents_transportation',
                            'description'       => 'Транспорті документи',
                            'type'              => fldText,
                            'maxlength'         => 150,
                            'display'           =>
                                array(
						...
						array(
                        'name'              => 'values_id',
                        'description'       => 'Параметри полiсу страхування',
                        ...
                        'table'             => 'policies_values_assignments',
                        ...
                        array(
                            ...
                            'type'              => fldText,
                            'maxlenght'         => 20,
							'validationRule'	=> '405.[0-9][0-9].[0-9]{6}',
                            'display'           =>
                                array(
                                    'show'      => true,
                                    'insert'    => false,
    ...
    function Policies_OneShipping($data) {
        Policies::Policies($data);

        $this->objectTitle = 'Policies_OneShipping';

        $this->messages['plural'] = 'Договори "Разове вантажоперевезення"';
        $this->messages['single'] = 'Договір "Разове вантажоперевезення"';
	...
	function showForm($data, $action, $actionType=null, $template=null) {
		...
		$sql =	'SELECT a.id, a.title ' .
				...
				'WHERE a.product_types_id = ' . PRODUCT_TYPES_ONE_SHIPPING . ' ' .
				'ORDER BY a.title';
	...
	function setAdditionalFields($id, $data) {
        ...
        $sql =  'UPDATE ' . PREFIX . '_policies AS a ' .
                'JOIN ' . PREFIX . '_policies_one_shipping AS b ON a.id = b.policies_id ' .
	...
	//Export 1C 7.7
     function getXML($data) {
      ...
      if ($data['number']) {
        ...
        return  $Smarty->fetch($this->object . '/one_shipping.xml');
    }
