<?
/*
 * Title: policy TransportAccidents class
 *
...
class Policies_TransportAccidents extends Policies {
                ...
                'fields'     =>
                    array(
						...
						array(
                            ...
                            'table'             => 'policies_transport_accidents'),
                       /*array(
                            'name'              => 'terms_years_id',
						...
						array(
                            ...
                            'description'       => 'Страхувальник, прізвище род',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Страхувальник, ім\'я род',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Страхувальник, по батькові род',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
						...
						array(
                            ...
                            'description'       => 'Страхувальник, посада род.',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
						...
						array(
                            ...
                            'description'       => 'Страхувальник 2, прізвище',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Страхувальник 2, ім\'я',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Страхувальник 2, по батькові',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
						...
						array(
                            'name'              => 'insurer_lastname_rod1',
                            'description'       => 'Страхувальник 2, прізвище род',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                            ...
                            'table'             => 'policies_transport_accidents'),
                        array(
                            'name'              => 'insurer_firstname_rod1',
                            'description'       => 'Страхувальник 2, ім\'я род',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                            ...
                            'table'             => 'policies_transport_accidents'),
                        array(
                            'name'              => 'insurer_patronymicname_rod1',
                            'description'       => 'Страхувальник 2, по батькові род',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Страхувальник 2, посада',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Страхувальник 2, діє на підставі',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
							...
							'showId'               => true,
                            'description'       => 'Застрах особа, тип особи',
                            'type'              => fldRadio,
                            'list'              => array(
                                                    '1' => 'Фiзична',
                                                    '2' => 'Юридична'),
                        ...
                        array(
                            ...
                            'description'       => 'Застрах особа, дата народження',
                            'type'              => fldDate,
                            'input'             => true,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'owner_lastname',
                            'description'       => 'Застрах особа, прізвище',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрах особа, ім\'я',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрах особа, по батькові',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'owner_phone',
                            'description'       => 'Застрах особа, телефон',
                            'type'              => fldText,
                            'validationRule'    => '^\([0-9]{3,5}\) [0-9]{1,3}-[0-9]{2}-[0-9]{2}$',
                            'maxlength'         => 15,
                            'display'           =>
						...
						array(
                            ...
                            'description'       => 'Застрах особа, область',
                            'type'              => fldSelect,
                            'display'           =>
                                array(
                                    'show'      => false,
                        ...
                        array(
                            'name'              => 'owner_area',
                            'description'       => 'Застрах особа, район',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'owner_city',
                            'description'       => 'Застрах особа, місто',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'owner_street',
                            'description'       => 'Застрах особа, вулиця',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'owner_house',
                            'description'       => 'Застрах особа, будинок',
                            'type'              => fldText,
                            'maxlength'         => 10,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'owner_flat',
                            'description'       => 'Застрах особа, квартира',
                            'type'              => fldText,
                            'maxlength'         => 4,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'type'              => fldText,
                            'maxlenght'         => 20,
							'validationRule'	=> '905.[0-9][0-9].[0-9]{6}',
                            'display'           =>
                                array(
                                    'show'      => true,
                                   'insert'    => false,
    ...
    function Policies_TransportAccidents($data) {
        Policies::Policies($data);

        $this->objectTitle = 'Policies_TransportAccidents';

        $this->messages['plural'] = 'Договори "Нещасні випадки на транспорті"';
        $this->messages['single'] = 'Договір "Нещасні випадки на транспорті"';
	...
	function showForm($data, $action, $actionType=null, $template=null) {
		...
		$sql =	'SELECT a.id, a.title ' .
				...
				'WHERE a.product_types_id = ' . PRODUCT_TYPES_TRANSPORT_ACCIDENTS . ' ' .
				'ORDER BY a.title';
	...
	function setAdditionalFields($id, $data) {
        ...
        $sql =  'UPDATE ' . PREFIX . '_policies AS a ' .
                'JOIN ' . PREFIX . '_policies_transport_accidents AS b ON a.id = b.policies_id ' .
    ...
    function insert($data, $redirect=true, $showForm=true, $checkFieldsAndReturn=false) {
        ...
        if (intval($data['id'])) {
            ...
            if ($Authorization->data['roles_id'] == ROLES_AGENT) {
                ...
                $sql =  'UPDATE ' . PREFIX . '_policies_transport_accidents SET ' .
    ...
    function getValues($file) {
		...
		$fields = array(
					...
					'owner_address',
					'closed');
		$r = $this->prepareValues($fields, $row);
        return $r;
    }
	...
	//Export 1C 7.7
     function getXML($data) {
      ...
      if ($data['number']) {
        ...
        return  $Smarty->fetch($this->object . '/transport_accidents.xml');
    }
