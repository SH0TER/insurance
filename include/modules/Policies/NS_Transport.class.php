...
require_once 'Products/NS_Transport.class.php';
require_once 'PolicyDocuments.class.php';
require_once 'FinancialInstitutions.class.php';

class Policies_NS_Transport extends Policies {
                ...
                'fields'     =>
                    array(
                        ...
                        array(
                            ...
                            'table'             => 'policies_ns_transport_parameters_assignments',
                        ...
                        array(
                            'name'                => 'info2',
                            'description'        => 'Наявність інших чинних договорів страхування щодо предмета договору',
                            'type'                => fldText,
                            'display'            =>
                                array(
                                    'show'        => false,
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, прізвище',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, ім\'я',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, по батькові',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, дата народження',
                            'type'              => fldDate,
                            'input'             => true,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, паспорт, серія',
                            'type'              => fldText,
                            'maxlength'         => 2,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, паспорт, номер',
                            'type'              => fldText,
                            'maxlength'         => 13,
                            //'validationRule'    => '^([0-9]{6}|[0-9]{6}\/[0-9]{6})$',
                            'display'           =>
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, паспорт, ким і де виданий',
                            'type'              => fldText,
                            'maxlength'         => 100,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, паспорт, дата видачі',
                            'type'              => fldDate,
                            'input'             => true,
                            'display'           =>
                                array(
                        ...
                        array(
                            ...
                            'description'       => 'Застрахований, область',
                            'type'              => fldSelect,
                            'display'           =>
                                array(
                                    'show'      => false,
                        ...
                        array(
                            'name'              => 'insured_area',
                            'description'       => 'Застрахований, район',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'insured_city',
                            'description'       => 'Застрахований, місто',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'insured_street',
                            'description'       => 'Застрахований, вулиця',
                            'type'              => fldText,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'insured_house',
                            'description'       => 'Застрахований, будинок',
                            'type'              => fldText,
                            'maxlength'         => 10,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'insured_flat',
                            'description'       => 'Застрахований, квартира',
                            'type'              => fldText,
                            'maxlength'         => 4,
                            'display'           =>
                                array(
                        ...
                        array(
                            'name'              => 'insured_phone',
                            'description'       => 'Застрахований, телефон',
                            'type'              => fldText,
                            //'validationRule'    => '^\([0-9]{3,5}\) [0-9]{1,3}-[0-9]{2}-[0-9]{2}$',
                            'maxlength'         => 15,
                            'display'           =>
                        ...
                        array(
                            'name'              => 'insured_email',
                            'description'       => 'Застрахований, e-mail',
                            'type'              => fldEmail,
                            'maxlength'         => 50,
                            'display'           =>
                                array(
    ...
    function Policies_NS_Transport($data) {
        global $db, $POLICY_STATUSES_SCHEMA;

        Policies::Policies($data);

        $this->objectTitle = 'Policies_NS_Transport';

        $this->messages['plural'] = 'Поліси "Нещасний випадок"';
        $this->messages['single'] = ($data['types_id'] == POLICY_TYPES_QUOTE) ? 'Котирування "Нещасний випадок на транспортi"' : 'Поліс "Нещасний випадок на транспортi"';
    ...
    function buildSelect($field, $value, $languageCode=null, $addition=null, $indexType=null, $data=null, $class=null) {
        ...
        if ($data['factor_types_id'] && eregi('values_id', $field['name']) ) {
    ...
    function setCommissions($id) {
        ...
        $sql =  'SELECT ' .
                ...
                'JOIN ' . PREFIX . '_policies_ns_transport AS b ON a.id = b.policies_id ' .
    ...
    function setAdditionalFields($id, $data) {
        ...
        $sql =  'UPDATE ' . PREFIX . '_policies AS a ' .
                ...
                'LEFT JOIN ' . PREFIX . '_car_models AS e1 ON b.models_id = e1.id ' .
                'LEFT JOIN ' . PREFIX . '_car_brands AS f1 ON e1.car_brands_id = f1.id ' .
        ...
        $this->updateRisks($id, PRODUCT_TYPES_NS_TRANSPORT, $data['risks'],  $data['products_id']);
        ...
        if (intval($data['id'])) {
            ...
            switch ($Authorization->data['roles_id']) {
                case ROLES_AGENT:
                    ...
                    $sql =  'UPDATE ' . PREFIX . '_policies_ns_transport SET ' .
    ...
    function update($data, $redirect=true, $showForm=true, $checkFieldsAndReturn=false) {
        ...
        if ($Authorization->data['permissions']['Policies_NS_Transport']['superupdate']) {//прочитать старый тариф для лога сообщений
        ...
        if ($data['id'] = parent::update(&$data, false, $showForm)) {
            ...
            if ($Authorization->data['permissions']['Policies_NS_Transport']['superupdate']) {//прочитать новый тариф для лога сообщений и создать сообщения
            ...
            switch ($field) {
                ...
                case 'insurer_address':
                 ...
                 case 'insured_address':
                    ...
                    if ($values['insured_regions_id']==27 && mb_eregi('евастополь', $values['insured_city']))
                        $values[ $field ] = $values['insured_city'];
                    ...
                    break;  
                 case 'assured_address':
                    $values[ $field ] = Regions::getTitle($values['assured_regions_id']);

                    if ($values['assured_area']) {
                        $values[ $field ] .= ', ' .$values['assured_area'] . ' р-н';
                    }

                    if (!in_array($values['assured_regions_id'], $REGIONS)) {
                        $values[ $field ] .= ', ' . $values['assured_city'];
                    }
                    
                    if ($values['assured_regions_id']==27 && mb_eregi('евастополь', $values['assured_city']))
                        $values[ $field ] = $values['assured_city'];

                    $values[ $field ] .=  ', ' . StreetTypes::getTitle($values['assured_street_types_id']) . ' ' . $values['assured_street'] . ', буд. ' . $values['assured_house'];

                    if ($values['assured_flat']) {
                                $values[ $field ] .= ', кв. ' . $values['assured_flat'];
                    }
                    break;  
                case 'payed':
    ...
    function getValues($file) {
        ...
        $sql =  'SELECT a.*, b.*, c.*, e.mfo as assured_mfo, DATE_SUB(begin_datetime, INTERVAL 1 DAY) AS endPaymentDate, DATE_ADD(DATE_SUB(begin_datetime, INTERVAL 1 DAY), INTERVAL 1 YEAR) AS endDateYear,  IF(payment_statuses_id<>' . PAYMENT_STATUSES_NOT . ' OR LENGTH(payment_number)>0, 0, 1) AS sample, ' .
                'd.title AS agencies_title, d.edrpou AS agencies_edrpou, d.ground_kasko_express AS ground_kasko, d.director1, d.director2, c.insurer_person_types_id as person_types_id,p.bill_bank_account,p.bill_bank_mfo ' .
        ...
        $sql ='SELECT b.types_id, b.title ' .
              'FROM ' . PREFIX . '_policies_ns_transport_parameters_assignments as a ' .
              'JOIN ' . PREFIX . '_parameters_ns as b ON b.id = a.values_id ' .
              'JOIN ' . PREFIX . '_policies_ns_transport as c ON c.policies_id = a.policies_id ' .
        ...
        foreach ($risks as $risk) {
         ...
         $fields = array(
                    'insurer_title',
                    'insurer_address','insured_address','assured_address',
                    'closed','payed', 'closed');
    ...
    function getLink($text, $fieldName, $fieldType) {
        ...
        switch ($Authorization->data['roles_id']) {
            case ROLES_ADMINISTRATOR:
                ...
                break;
            case ROLES_MANAGER:
                $reset =($Authorization->data['permissions']['Policies_NS_Transport']['update']) ? true : false;
                break;
        }
...
//            $conditions[] = 'a.id = ' . intval($data['policies_id']);
        ...
        if (!$conditions) {
            ...
            $sql =  'SELECT b.policies_id, CONCAT(b.insurer_lastname, \' \', b.insurer_firstname, \' \', b.insurer_patronymicname) AS insurer, a.number, date_format(a.date, ' . $db->quote(DATE_FORMAT) . ') as date_format, date_format(a.begin_datetime, ' . $db->quote(DATE_FORMAT) . ') AS begin_datetime_format, date_format(a.interrupt_datetime, ' . $db->quote(DATE_FORMAT) . ') AS interrupt_datetime_format ' .
                    'FROM ' . PREFIX . '_policies AS a ' .
                    'JOIN ' . PREFIX . '_policies_ns_transport AS b ON a.id = b.policies_id ' .
                    //'JOIN ' . PREFIX . '_policies_ns_transport_items AS c ON a.id = c.policies_id ' .
                    'WHERE ' . implode(' AND ', $conditions) . ' ' .
    ...
    function getShowFieldsSQLString() {
        ...
        $result .= ', insurance_policies_ns_transport.financial_institutions_id ';
